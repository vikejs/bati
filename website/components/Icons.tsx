...
export function IconInfo(props: { class?: string }) {
  return <span class={clsx(props.class)}>🛈</span>;
}
...
export function IconTrainTrack(props: { class?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" class={clsx("fill-current", props.class)} viewBox="0 0 64 64">
      ...
      <path
        fill="#a87c4f"
        d="M63.45 52.53c0 .672-1.126 1.215-2.51 1.215H2.5c-1.385 0-2.508-.543-2.508-1.215l3.154-8.339c0-.673 1.121-1.217 2.505-1.217h52.13c1.385 0 2.508.544 2.508 1.217l3.155 8.339M55.26 35.26c0 .497-.836.901-1.863.901h-43.35c-1.029 0-1.861-.404-1.861-.901l2.34-6.188c0-.497.833-.902 1.859-.902h38.671c1.029 0 1.861.405 1.861.902l2.341 6.188m-5.297-13.3c0 .387-.646.7-1.44.7H14.933c-.792 0-1.44-.313-1.44-.7l1.813-4.794c0-.385.645-.698 1.442-.698h29.961c.794 0 1.44.313 1.44.698l1.812 4.794m-4.481-9.424c0 .29-.486.529-1.089.529H19.063c-.603 0-1.089-.239-1.089-.529l1.369-3.615c0-.293.487-.525 1.085-.525h22.6c.6 0 1.089.231 1.089.525l1.363 3.615"
      />
      <path
        fill="#929497"
        d="M13.1 61.51c-.614 1.875-3.99 2.534-5.949 1.943c-1.959-.589-4.337-2.975-3.723-4.85l20.706-56.11c.615-1.877 1.802-2.921 3.761-2.33c1.957.588 2.146 2.585 1.532 4.462L13.1 61.509"
      />
      <path
        fill="#b1b1b2"
        d="M9.829 63.45c-1.959-.589-4.337-2.973-3.723-4.85L26.811 2.49c.327-1 .822-1.76 1.504-2.167a2.853 2.853 0 0 0-.419-.164c-1.959-.589-3.146.453-3.761 2.33L3.429 58.599c-.614 1.877 1.764 4.261 3.723 4.85c.84.253 1.935.275 2.965.073a4.329 4.329 0 0 1-.288-.073"
      />
      <path
        fill="#929497"
        d="M50.26 61.51c.618 1.875 3.99 2.534 5.951 1.943c1.959-.589 4.339-2.975 3.725-4.85L39.228 2.493c-.612-1.877-1.8-2.921-3.759-2.33c-1.959.588-2.146 2.585-1.532 4.462L50.26 61.509"
      />
      <path
        fill="#b1b1b2"
        d="M53.53 63.45c1.959-.589 4.335-2.973 3.723-4.85L36.545 2.49c-.327-1-.817-1.76-1.5-2.167c.13-.062.266-.12.419-.164c1.959-.589 3.146.453 3.759 2.33l20.708 56.11c.614 1.877-1.766 4.261-3.725 4.85c-.84.253-1.934.275-2.965.073c.098-.02.196-.045.289-.072"
      />
    </svg>
  );
}
...
export function IconAlembic(props: { class?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" class={clsx("fill-current", props.class)} viewBox="0 0 36 36">
      ...
      <ellipse cx="15.41" cy="16.139" fill="#3B94D9" rx="11.818" ry="1.629" />
      <ellipse cx="34.047" cy="9.982" fill="#AAB8C2" rx="1.341" ry=".974" transform="rotate(-74.365 34.047 9.981)" />
    </svg>
  );
}
