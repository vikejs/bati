...
export default async function getReadme(props: TransformerProps) {
  ...
  //language=Markdown
  const intro = `Generated with [vike.dev/new](hhttps://vike.dev/new) ${`(${markdown.link("https://www.npmjs.com/package/create-vike/v/" + v.version, "version " + v.semver.at(-1))})`} using this command:
