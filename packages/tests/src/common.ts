...
import type { BatiKnipConfig } from "@batijs/core/config";
...
export async function createKnipConfig(projectDir: string, _flags: string[], scripts: Record<string, string>) {
  ...
  // Extended knip config type with additional JSON schema properties
  type KnipJsonConfig = BatiKnipConfig & {
    $schema?: string;
    rules?: Record<string, string>;
  };

  // Try to read existing knip.json (generated by CLI with --knip flag)
  let knipConfig: KnipJsonConfig;
