...
export const features = [
  ...
  // AI Agent — stack-tailored skills generated into every scaffold. Always on and hidden everywhere
  // (no CLI flag, not shown in the Web UI); the shared-agents boilerplate composes the SKILL.md files.
  {
    category: "AI Agent",
    label: "Agent Skills",
    flag: "skills",
