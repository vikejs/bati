...
export const features = [
  ...
  {
    category: "Hosting",
    label: "AWS Lambda / Serverless Framework",
    flag: "aws-lambda-serverless",
    image:
    ...
    tagline:
      "Deploy APIs, scheduled tasks, workflows and event-driven apps to AWS Lambda easily with the Serverless Framework. Currently flag '--hono' is required.",
    links: [
      {
        label: "Docs",
        href: "https://github.com/serverless/serverless/tree/v3?tab=readme-ov-file",
      },
    ],
  },
